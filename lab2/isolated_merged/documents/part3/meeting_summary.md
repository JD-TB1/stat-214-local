...
- `HistGradientBoosting` + `B3_context_ae`: mean ROC AUC=0.9547, mean PR AUC=0.9073, mean balanced accuracy=0.9001
- `HistGradientBoosting` + `B2_context`: mean ROC AUC=0.9399, mean PR AUC=0.8710, mean balanced accuracy=0.8774
- `Random Forest` + `B3_context_ae`: mean ROC AUC=0.9272, mean PR AUC=0.8891, mean balanced accuracy=0.8367
...
- `Random Forest` + `B2_context`: mean ROC AUC=0.9194, mean PR AUC=0.8592, mean balanced accuracy=0.8230

## Best block per family
- `HistGradientBoosting` best block `B3_context_ae`: mean ROC AUC=0.9547, mean PR AUC=0.9073
- `Random Forest` best block `B3_context_ae`: mean ROC AUC=0.9272, mean PR AUC=0.8891
- `Logistic Regression` best block `B2_context`: mean ROC AUC=0.8546, mean PR AUC=0.7900
